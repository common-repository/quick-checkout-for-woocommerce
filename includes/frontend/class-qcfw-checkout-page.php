...
class Qcfw_Checkout_Page {
	...
	public function qcfw_cart_on_checkout_page() {
		...
		$settings   						= Qcfw_Checkout_Settings::get_settings();
		$qcfw_checkout_cart_checkout_page 	= isset( $settings['qcfw_checkout_cart_checkout_page'] ) ? $settings['qcfw_checkout_cart_checkout_page'] : '';

		if($qcfw_checkout_cart_checkout_page):
				...
				<table class="shop_table shop_table_responsive cart woocommerce-cart-form__contents" cellspacing="0">
					<thead>
						<tr>
							...
							<th class="product-thumbnail"><span><?php esc_html_e( 'Thumbnail image', 'woocommerce' ); ?></span></th>
